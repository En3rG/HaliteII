...
class Constants():
    ...
    ## FOR STRONG ENOUGH DETERMINATION
    DYING_HP = 130

    ## DEFENDING MINERS
    DEFENDING_PERIMETER_CHECK = 21      ## BEST AT 14, 14, 14 ??? ACTUALLY 21 21 21 SEEMS BETTER
    DEFENDING_BACKUP_CIRCLE_RADIUS = 21
    DEFENDING_BACKUP_SQUARE_RADIUS = 21
