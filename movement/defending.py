...
def defend_if_enemy_near(MyMoves, ship_id, ship_coord):
    ...
    v_section = MyCommon.get_section_with_padding(value_array,
                                                  ship_coord,
                                                  MyCommon.Constants.DEFENDING_PERIMETER_CHECK,
                                                  pad_values=0)
    ...
    if Matrix_val.ENEMY_SHIP.value in v_section:
        ...
        mid_coord = MyCommon.Coordinates(MyCommon.Constants.DEFENDING_PERIMETER_CHECK,
                                         MyCommon.Constants.DEFENDING_PERIMETER_CHECK)
